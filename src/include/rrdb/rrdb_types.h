...
typedef struct _get_scanner_request__isset {
  _get_scanner_request__isset() : start_key(false), stop_key(false), start_inclusive(false), stop_inclusive(false), batch_size(false), no_value(false), hash_key_filter_type(false), hash_key_filter_pattern(false), sort_key_filter_type(false), sort_key_filter_pattern(false), need_check_hash(false) {}
  bool start_key :1;
  bool stop_key :1;
  bool start_inclusive :1;
  bool stop_inclusive :1;
...
class get_scanner_request {
 public:
  ...
  get_scanner_request() : start_inclusive(0), stop_inclusive(0), batch_size(0), no_value(0), hash_key_filter_type((filter_type::type)0), sort_key_filter_type((filter_type::type)0), need_check_hash(0) {
  }
  ...
  void __set_need_check_hash(const bool val);
  ...
  bool operator == (const get_scanner_request & rhs) const
  {
    ...
    if (!(sort_key_filter_pattern == rhs.sort_key_filter_pattern))
      return false;
    if (!(need_check_hash == rhs.need_check_hash))
      return false;
    return true;
  }
  bool operator != (const get_scanner_request &rhs) const {
